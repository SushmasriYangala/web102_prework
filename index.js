...
const resultMessage = unfundedCount === 1 ? 
  `There is 1 unfunded game.` : 
  `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently ${unfundedCount} games remain unfuned. We need your help to fund these amazing games!`;
